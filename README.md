...
[The Coding Train](https://www.youtube.com/@TheCodingTrain). More specificlly, his [p5js playlist](https://www.youtube.com/playlist?list=PLRqwX-V7Uu6Zy51Q-x9tMWIv9cueOFTFA).


Fast forward 2 years, I decided to use the "Elegoo Uno Super Starter Kit" that had been lying around. 
It contained a Elegoo Uno R3 board which is like the Arduino Uno R3 board, the kit also comes along with some electronic components.
